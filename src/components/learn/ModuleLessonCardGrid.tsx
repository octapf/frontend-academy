      ...
      {lessons.map((l) => {
        ...
        return (
          <TrackLink
            ...
            className="flex flex-col rounded-xl border border-zinc-200 bg-zinc-100 p-5 transition-colors hover:bg-zinc-900/5 dark:border-zinc-700 dark:bg-zinc-950 dark:hover:bg-zinc-100/10"
          >
